...
$sql = "SELECT tiempo, nombre_fichero FROM testmongo WHERE Id_prueba = 'MON_2' ORDER BY nombre_fichero;";
...
$sql = "SELECT tiempo, nombre_fichero FROM testcassandra WHERE Id_prueba = 'CAS_2' ORDER BY nombre_fichero;";
$result = $conexion->query($sql);
...
$graph->title->Set('GEN_2: Búsqueda sobre un campo con valores menores de uno dado.');
$graph->SetBox(false);
...
$graph->Add($p1);
$p1->SetColor("#6495ED");
$p1->SetLegend('Prueba MON_2 en Mongodb');
 
// Create the second line
$p2 = new LinePlot($y2_axis);
$graph->Add($p2);
$p2->SetColor("#B22222");
$p2->SetLegend('Prueba CAS_2 en Cassandra');
