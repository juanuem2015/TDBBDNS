...
$sql = "SELECT NombreFicheroCarga, TiempoCarga FROM cargadatosmongo order by NombreFicheroCarga";
...
$sql = "SELECT NombreFicheroCarga, TiempoCarga FROM cargadatoscassandra order by NombreFicheroCarga ";
$result = $conexion->query($sql);
...
$graph->title->Set('Tiempo de carga');
$graph->SetBox(false);
...
$graph->Add($p1);
$p1->SetColor("#6495ED");
$p1->SetLegend('Tiempo de carga en Mongodb');
 
// Create the second line
$p2 = new LinePlot($y2_axis);
$graph->Add($p2);
$p2->SetColor("#B22222");
$p2->SetLegend('Tiempo de carga en Cassandra');
